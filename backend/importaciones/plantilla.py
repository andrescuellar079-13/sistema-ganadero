...
def generar_plantilla():
    ...
    lineas = [
        ...
        "• Los encabezados aceptan variantes (ej: 'arete', 'código', 'parcela', 'peso'); no hace falta el nombre exacto.",
        "• Razas, categorías y parcelas que no existan pueden crearse solas si activás esa opción al importar.",
