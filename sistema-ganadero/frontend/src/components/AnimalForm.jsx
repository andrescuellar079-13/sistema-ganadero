// frontend/src/components/AnimalForm.jsx
...
export default function AnimalForm({ animal, razas, categorias, fincaId, onSubmit, onCancel }) {
  ...
  // Cargar detalle completo al editar
  ...
  const handleSubmit = (e) => {
    ...
    // Solo agregar estado si es edición (animal existe)
    if (isEditing) {
      baseData.estado = formData.estado
    }
      ...
      <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        <div className="p-6">
          <h2 className="text-lg font-bold text-gray-800 mb-4">
            {isEditing ? '✏️ Editar Animal' : '🐄 Nuevo Animal'}
          </h2>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <input
                      ...
                      readOnly={isEditing}
                      style={isEditing ? { background: '#f9f9f9', color: '#555' } : {}}
                    />
                  </div>
                  <div>
